...
setwd("/Volumes/GoogleDrive/My Drive/GEMS/BILD-AQ")
state = 'CA'
analysis_year = 2010
...
# write output
st_write(census_tracts, 'shapefile/CA_census_tracts_2010.geojson')
st_write(census_tract_centroid, 'shapefile/CA_census_tracts_centroids_2010.geojson')
write.csv(centroid_distance, 'distance_matrix_by_tracts.csv')
