...
# load list of route
list_of_routes = os.listdir('route/' + selected_state + '_external')
routes_dir = 'route/' + selected_state + '_external'
# <codecell>

# load output from step 2:
import zipfile
trip_attrac_with_choice_file = 'CA/OD_home_based_trips_spillover.csv.zip'
