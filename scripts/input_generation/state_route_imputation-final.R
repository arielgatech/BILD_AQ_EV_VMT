...
cl <- parallel::makeCluster(num_cores-1) #if 32 cores: 27 is max as anything above seems to crash. else: num_Cores-1
...
old_files <- list.files("C:/Users/cguirado/Downloads/drive-download/route/processed", pattern = "*.geojson", full.names = TRUE)
new_files <- paste0("C:/Users/cguirado/Downloads/drive-download/route/processed/final/imputed_CA_route_",1:length(old_files),".geojson")
