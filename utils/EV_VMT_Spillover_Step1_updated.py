...
# ####### REPLACE WITH CORRECT STATE - LOAD THE RIGHT TRACT TO BORDER DISTANCE MATRIX
...
# clean up path
final_df.to_csv('tract_to_border_distance_CA.csv')
...
# We now have a dataframe with the ID of every out-of-state tract and the number of occurrences
dest_count_df.head()
...
print(origin_tracts[0:5])
print(dist_matrix['origin'].dtype)
